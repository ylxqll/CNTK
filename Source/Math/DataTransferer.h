...
namespace Microsoft { namespace MSR { namespace CNTK {
    ...
    // This interface has a low granulatiry operations, so that it is possible to issue several operations and wait on them at the end.
    // I.e.
    // CopyGPUToCPUAsync
    ...
    {
    public:
        // Asynchronously starts coping data from gpu into cpu buffer on internal stream.
        ...
        // Asynchronously starts coping data from cpu into gpu buffer.
